...
process mapping {
	...
	cp tophat_out/accepted_hits.bam tophat_out/accepted_hits_notfiltered.bam2
	samtools view -bq 20 tophat_out/accepted_hits.bam > tophat_out/accepted_hits_filtered.bam
        mv tophat_out/accepted_hits_filtered.bam ${bam_name}.bam
        """
    }
}
